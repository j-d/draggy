<?php
// Autocode\Templates\PHP\CrudUpdateTwig.php
...
use Autocode\Templates\PHP\Base\CrudUpdateTwigBase;
// <user-additions part="use">
// </user-additions>

/**
 * Autocode\Templates\PHP\Entity\CrudUpdateTwig
 */
    ...
    // </user-additions>
{
    ...
    public function render()
    {
        ...
        $file .= "\n";
        $file .= 'echo    T::block_(\'title\'), \'Edit ' . $entity->getName() . '\', T::_BLOCK;' . "\n";
        $file .= "\n";
        $file .= '$form = new Table();' . "\n";
        $file .= "\n";
        $file .= '$form' . "\n";
        ...
        $file .= '        new Cell(new Submit(\'#submit\',\'Save\',[\'validate\'=>\'\']),[\'colspan\'=>2],\'center\')' . "\n";
        $file .= '    );' . "\n";
        $file .= "\n";
        $file .= 'echo    T::block(\'body\'),' . "\n";
        $file .= '            T::PARENT,' . "\n";
        $file .= '            T::form([\'' . strtolower($entity->getModuleNoBundle()) . '_' . strtolower($entity->getName()) . '_edit\',[\'id\'=>\'{{ id }}\']],\'form\'),' . "\n";
