...
abstract class EntityCodeBase
{
    ...
    {
        if (!$toString instanceof Attribute && null !== $toString) {
            throw new \InvalidArgumentException('The attribute toString on the class Entity has to be Attribute or null (' . gettype($toString) . ('object' === gettype($toString) ? ' ' . get_class($toString) : '') . ' given).');
        }
